...
Like the standard sharp palette, this targets pure black/white backgrounds.
For each hue angle, lightness is adjusted to hit a target APCA Lc value, then
chroma is maximized to the sRGB gamut boundary at that lightness.
"""
...
def get_colors(
    ...
    return ColorPalette(colors=colors, name="OkColors-Sharp-APCA Accent Colors")
